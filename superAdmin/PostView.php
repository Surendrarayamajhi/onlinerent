...
if (isset($_GET['app'])) {
    $post_id = $_GET['app'];
    // Update the isApproved status to 1
    $sql = "UPDATE posts SET is_approved = 1 WHERE p_id = $post_id";
    $res = runQuery($sql);
    if ($res) {
...
if (isset($_GET['disapp'])) {
    $post_id = $_GET['disapp'];
    // Update the isApproved status to 2
    $sql = "UPDATE posts SET is_approved = 2 WHERE p_id = $post_id";
    $res = runQuery($sql);
    if ($res) {
        header("Location: PostView.php?id=$post_id");
    }
            ...
            <div class="main__container">
                ...
                <div class="">
                    <div class="css-view-hero">
                        <!-- <img src="../images/<?php echo $row; ?>" alt="" style="width: 100px; height: 100px" /> -->
                        <div>
                            <h5>Photo Gallary</h5>
                  ...
                  <div class="carousel-item ">
                    <img src="../assets/images/hero (4).jpg" class="d-block w-100" alt="...">
                        ...
                        <div class="pt-0 pt-sm-0 pt-md-0 pt-lg-4 mt-0 mt-sm-0  mt-md-0  mt-lg-3">
                            ...
                            <div class="d-flex align-items-center gap-3 ad-view-control-wrap shadow p-3">
                                <a href="PostView.php?app=<?php echo $postId; ?>" class="btn btn-success btn-sm">Approve Post</a>
                                <a href="PostView.php?disapp=<?php echo $postId; ?>" class="btn btn-outline-danger btn-sm">Disapprove Post</a>
                            </div>
