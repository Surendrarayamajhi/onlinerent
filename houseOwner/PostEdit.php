...
<body id="body">
        ...
        <div id="sidebar">
            ...
            <div class="sidebar__menu">
                ...
                <div class="sidebar__link">
                    ...
                    <a href="Posts.php">Interested Users</a>
                </div>
    ...
    <!-- <div class="col-2 lists" id="default-file">
        <div>
            <label for="formFile" class="form-label">Images</label>
            <input class="form-control mt-2 file" type="file" name="input_img_1" id="formFile">
        </div>
    </div>
    <button id="add-image-btn" class="btn btn-outline-primary" type="button" onclick="addImg();">Add More Image</button> -->
