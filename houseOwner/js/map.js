        ...
        //                 inputLong.setAttribute('value',lon);
        //             },
        //             function (error) {
        ...
        //     // Create a marker at the current location
        //     if(gpsMarker){
        //         console.log('called gps remove')
        //         map.removeLayer(gpsMarker);
        //     }
        //     if(itahariMarker){
        //         console.log('called itahari remove')
        //         map.removeLayer(itahariMarker);
        //     }
...
function getCurrentLocation() {
    ...
    if (navigator.geolocation) {
        ...
        function changeLoc() {
            console.log('gmark ' + gpsMarker);
            console.log('chgMark ' + itahariMarker);
    newLat = inputLat.value;
    newLong = inputLong.value;
    ...
    if (gpsMarker) {
        console.log('Removing gpsMarker');
        map.removeLayer(gpsMarker);
    }
    
    if (itahariMarker) {
        console.log('Removing itahariMarker');
        map.removeLayer(itahariMarker);
    }

    if (changeMark) {
        console.log('Removing changeMark');
        map.removeLayer(changeMark);
    }
