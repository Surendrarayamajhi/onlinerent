...
<head>
    ...
    <style>
        .active-menu-link {
            background: rgba(62, 161, 117, 0.3) !important;
            color: #3ea175;
            /* color: #00b4ff; */
        }
    </style>
    ...
    <div class="css-container">
                        ...
                        <tbody>
                            ...
                            if ($result && mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo '<td>' . $userName . '</td>';
                                    echo '<td>' . $email . '</td>';
                                    echo '<td class="text-success">' . $contact . '</td>';
                                    echo '<td>' . $createdAt . '</td>';
                                    echo '<td><a href="PostView.php?id=' . $postId . '" class="btn btn-primary btn-sm">View</a></td>';
        ...
        <div id="sidebar">
            ...
            <div class="sidebar__menu">
                ...
                <div class="sidebar__link active-menu-link">
                    <i class="fa-solid fa-users"></i>
                    <a href="Interested.php">Interested User</a>
                </div>
